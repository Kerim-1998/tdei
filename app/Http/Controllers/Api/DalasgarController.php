...
class DalasgarController extends Controller
{
        /**
    ...
    {
      $edusundiris = DB::table('dalasgars')->where('id',$id)->first();
       return response()->json($edusundiris);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user = DB::table('dalasgars')->where('id',$id)->update($data);
    ...
    {
        DB::table('dalasgars')->where('id',$id)->delete();
    }
}
