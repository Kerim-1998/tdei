...
<template>
 ...
 <div class="row">
  <router-link to="/dalasgar" class="btn btn-primary">Ahli dalasgar </router-link>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"> dalasgar Update</h1>
                  </div>

      <form class="user" @submit.prevent="dalasgarUpdate">
...
<script type="text/javascript">
  ...
  dalasgarUpdate(){
      let id = this.$route.params.id
       axios.patch('/api/dalasgar/'+id,this.form)
       .then(() => {
